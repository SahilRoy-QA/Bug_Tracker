          ...
          <div className="bg-rose-500/5 rounded-2xl p-6 border border-rose-500/20 shadow-xs">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                ...
                <span>Reset All Project Data to Clean v6.1.0 Template</span>
              </button>
            </div>
          </div>
        </div>
      ...
      {confirmTemplateResetOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs">
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 w-full max-w-sm shadow-2xl p-6 text-center animate-in fade-in zoom-in-95">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">
              Reset Project to v6.1.0 Template?
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
              This resets project details, dates, test suite names, and defect logs back to standard version 6.1.0 (Rev. 2620) initial state.
            </p>
            ...
            <div className="mt-5 flex justify-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  onResetTemplate();
                  showNotice('Project reset to initial v6.1.0 template.', 'success');
                }}
